...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <fieldset>
        ...
        <div class="editor-field">
            <%: Html.DropDownList("sem_list", new SelectList(Model.Semesters.ToList(), "semester_id", "semester_id",Model.Classes.semster_id))%>
        ...
        <div class="editor-field">
            <%: Html.DropDownList("course_list", new SelectList(Model.Courses.ToList(), "course_id", "course_id",Model.Classes.course_id))%>
        ...
        <div class="editor-field">
            ...
            <%: Html.DropDownList("inst_list", new SelectList(names, "Id", "Name",Model.Classes.inst_id))%>
        ...
        <div class="editor-field">
            ...
            <%: Html.DropDownList("time_list", new SelectList(times, "Id", "Name", Model.Classes.timeslot_id))%>
